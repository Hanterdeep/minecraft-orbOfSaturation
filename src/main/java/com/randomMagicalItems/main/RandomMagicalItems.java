package com.randomMagicalItems.main;

import com.randomMagicalItems.proxy.CommonProxy;
...
public class RandomMagicalItems {
    ...
    public static final String CLIENT_PROXY = "com.randomMagicalItems.proxy.ClientProxy";
    public static final String COMMON_PROXY = "com.randomMagicalItems.proxy.CommonProxy";
